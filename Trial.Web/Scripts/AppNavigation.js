(function (namespace, $) {
    ...
    p._clickEvents = function () {
        $(document.body).on("click", ".clickPrev", function () {
            $(this).prev().click();
        });
    };
    ...
    p._initFancyBox = function () {
        if (!$.isFunction($.fn.fancybox)) {
            return;
        }
        if ($(".jsFancyBox").length > 0) {
            $(".jsFancyBox").fancybox();
        }
    };
    ...
    p._selectProjectBrands = function () {

        p._brandProjectList(".jsProjectList");

        $(document.body).on("click", ".jsChoose", function (e) {
            var $this = $(this);
            var brandId = $this.data("brand");
            var projectId = $this.data("project");
            if (brandId !== undefined && projectId !== undefined) {
                $(".jsChoose.True").removeClass("True");
                $this.addClass("True");
                $("#jsChooseBrandId").val(brandId);
                $("#jsChooseProjectId").val(projectId);
            }
        });
    };

    p._brandProjectList = function (elementString) {
        if (!$.isFunction($.fn.nanoScroller)) {
            return;
        }

        // Get scrollbar elements
        var menuScroller = $(elementString);
    ...
    p._modalEvents = function () {

        $(document.body).on("click", ".deleteModal", function (e) {
            e.preventDefault();
            var $this = $(this);
            ...
            if ($url !== undefined) {
                ...
                $modal.modal("show");
                $modal.find(".jsHref").attr("data-href", $url);
            }
        });

        $(document.body).on("click", ".jsHref", function (e) {
            e.preventDefault();
            var $this = $(this);
    ...
    p._enableEvents = function () {
        ...
        $(document.body).on("click", ".jsShowHidePanel", function (e) {
            var $this = $(this);
    ...
    p._nanoScroller400 = function (elementString) {
        if (!$.isFunction($.fn.nanoScroller)) {
            return;
        }
